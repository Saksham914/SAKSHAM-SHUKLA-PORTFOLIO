...
export default function CertificatesPage() {
  ...
  const [credentialUrl, setCredentialUrl] = useState("https://www.linkedin.com/in/sakshamshukla123/details/certifications/");
  ...
  const resetForm = () => {
    setTitle("");
    setCredentialUrl("https://www.linkedin.com/in/sakshamshukla123/details/certifications/");
    setImage(null);
    setPreview("");
    setEditId(null);
  };
  ...
  const handleEdit = (item: any) => {
    setTitle(item.title);
    setCredentialUrl(item.credential_url || item.certificate_url || item.link_url || item.link || "https://www.linkedin.com/in/sakshamshukla123/details/certifications/");
        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-end sm:items-center justify-center px-3 sm:px-4 py-4">
          <div className="w-full max-w-md rounded-t-3xl sm:rounded-3xl bg-[#111] border border-white/10 p-5 sm:p-6 max-h-[92vh] overflow-y-auto">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-2xl bg-[#0f0f0f] border border-white/10 outline-none mb-3 text-sm"
            />

            {/* CREDENTIAL URL */}
            <input
              placeholder="Credential URL (LinkedIn / Verification link)"
              value={credentialUrl}
