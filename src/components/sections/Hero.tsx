...
const skills = ["Python", "SQL", "Pandas", "NumPy", "React.js", "MySQL"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["Data Analytics Enthusiast", "Software Developer", "B.Tech CSE Student"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            Enthusiastic about data analysis, feature engineering, statistical modeling, and full-stack software development. Turning complex data and ideas into impactful digital solutions.
          </p>
        </motion.div>
